...
var recipes = [
    ...
    },
    {
        ...
        instructions: [
            ...
            "Remove skillet from heat. Quickly pour in egg mixture while tossing pasta vigorously to create a smooth, creamy sauce. Add reserved pasta water if needed.",
...
btn.onclick = function() {
    ...
    document.getElementById('recipe-image').src = current.image;
    ...
    document.getElementById('recipe-tags').innerHTML = current.tagsHTML;
    ...
    if (cookTimeInt > 45) {
        document.getElementById('time-warning-container').innerHTML = 
            `<div class="extended-time-warning d-flex align-items-start">
                ...
                <div>
                    <div class="warning-title">Extended Preparation Time</div>
    ...
    document.getElementById('tips-list').innerHTML = tipsBox;

    var nutBox = '';
    nutBox += `<div class="col-md-6"><div class="nutrition-card p-3 rounded-4 d-flex align-items-center"><div class="nutrition-icon bg-orange-soft text-orange-icon me-3"><i class="fas fa-fire"></i></div><div class="nutrition-name flex-grow-1 fw-semibold">Calories</div><div class="nutrition-value fw-bold fs-5">${current.cal}</div></div></div>`;
    nutBox += `<div class="col-md-6"><div class="nutrition-card p-3 rounded-4 d-flex align-items-center"><div class="nutrition-icon bg-blue-soft text-blue-icon me-3"><i class="fas fa-dumbbell"></i></div><div class="nutrition-name flex-grow-1 fw-semibold">Protein</div><div class="nutrition-value fw-bold fs-5">${current.pro}</div></div></div>`;
    nutBox += `<div class="col-md-6"><div class="nutrition-card p-3 rounded-4 d-flex align-items-center"><div class="nutrition-icon bg-yellow-soft text-yellow-icon me-3"><i class="fas fa-wheat-awn"></i></div><div class="nutrition-name flex-grow-1 fw-semibold">Carbohydrates</div><div class="nutrition-value fw-bold fs-5">${current.carbs}</div></div></div>`;
    nutBox += `<div class="col-md-6"><div class="nutrition-card p-3 rounded-4 d-flex align-items-center"><div class="nutrition-icon bg-red-soft text-red-icon me-3"><i class="fas fa-droplet"></i></div><div class="nutrition-name flex-grow-1 fw-semibold">Fat</div><div class="nutrition-value fw-bold fs-5">${current.fat}</div></div></div>`;
    nutBox += `<div class="col-md-6"><div class="nutrition-card p-3 rounded-4 d-flex align-items-center"><div class="nutrition-icon bg-green-soft text-green-icon me-3"><i class="fas fa-leaf"></i></div><div class="nutrition-name flex-grow-1 fw-semibold">Fiber</div><div class="nutrition-value fw-bold fs-5">${current.fib}</div></div></div>`;
    nutBox += `<div class="col-md-6"><div class="nutrition-card p-3 rounded-4 d-flex align-items-center"><div class="nutrition-icon bg-pink-soft text-pink-icon me-3"><i class="fas fa-cube"></i></div><div class="nutrition-name flex-grow-1 fw-semibold">Sodium</div><div class="nutrition-value fw-bold fs-5">${current.sod}</div></div></div>`;
